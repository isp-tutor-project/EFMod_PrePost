...
/* ######################################################### */
	...
	private init3() {
		...
		this.traceMode = true;
		if(this.traceMode) CUtil.trace("TImgTool:Constructor");
...
/*  ###########  END CREATEJS SUBCLASS SUPPORT ###########   */
    ...
    // This is a requirement introduced by the need to manually add controls in the onAddedToStage
	...
	public onAddedToStage(evt:CEFEvent) {
        ...
        if(!this.fAdded) {
            ...
            // Destroy the CREATEJS timeline - it would duplicate components
            //
            ...
            // TODO: ensure only creating one copy
	...
	{
		this[this.feature1A].on(TMouseEvent.CLICK, this.dofeature1A, this);
		this[this.feature1B].on(TMouseEvent.CLICK, this.dofeature1B, this);
		
		this[this.feature2A].on(TMouseEvent.CLICK, this.dofeature2A, this);
		this[this.feature2B].on(TMouseEvent.CLICK, this.dofeature2B, this);
		
		this[this.feature3A].on(TMouseEvent.CLICK, this.dofeature3A, this);
		this[this.feature3B].on(TMouseEvent.CLICK, this.dofeature3B, this);
	}
