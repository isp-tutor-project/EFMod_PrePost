...
import { THouseImgTool } 	from "../../thermite/THouseImgTool";
...
export class TIntroPart3 extends TScene
{
	...
	public i3Check1:TImgCircleControl;
	public i3Check2:TImgCircleControl;
	public i3Check3:TImgCircleControl;
	public i3Check4:TImgCircleControl;
	public i3Check5:TImgCircleControl;
	public i3Check6:TImgCircleControl;
	...
	constructor()
	{
		...
		this.i3Check1.on(CONST.BUTTON_CLICK, this.onCheck1, this);			
		this.i3Check2.on(CONST.BUTTON_CLICK, this.onCheck2, this);						
		this.i3Check3.on(CONST.BUTTON_CLICK, this.onCheck3, this);			
		this.i3Check4.on(CONST.BUTTON_CLICK, this.onCheck4, this);						
		this.i3Check5.on(CONST.BUTTON_CLICK, this.onCheck5, this);			
		this.i3Check6.on(CONST.BUTTON_CLICK, this.onCheck6, this);						
	}
