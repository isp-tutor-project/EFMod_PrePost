...
export class TQ1BPart1 extends TExpSceneTyp2
{
	...
	constructor()
	{
		...
		this.imgToolAq1.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapA, this);			
		this.imgToolBq1.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapB, this);			
		this.tabControllerAq1.on(TSelectEvent.WOZTABSELECT,  this.doTabMapA, this);
		this.tabControllerBq1.on(TSelectEvent.WOZTABSELECT,  this.doTabMapB, this);				  
	}
	...
	public onGotoDesign(evt:TMouseEvent)
	{
		...
		this.q1DesignButton.removeEventListener(CONST.BUTTON_CLICK, this.onGotoDesign);				
...
*/
		...
		//## Mod 10 10 2012 - inhibit double click on design button - was causing skip directly to partB
		this.q1DesignButton.on(CONST.BUTTON_CLICK, this.onGotoDesign, this);				
