...
export class TQ2APart1 extends TExpSceneTyp2
{
	...
	constructor()
	{
		...
		this.this.q2Check2.label("Bad Way");
		
		this.this.q2Check1.on(CONST.BUTTON_CLICK, this.check1Clicked, this);			
		this.this.q2Check2.on(CONST.BUTTON_CLICK, this.check2Clicked, this);						
	}
