...
export class TQ2APart3 extends TExpSceneTyp2
{
	...
	public q2TextControl1:THtmlText;
	
	public q2Check1:TImgCircleControl;
	public q2Check2:TImgCircleControl;
	...
	constructor()
	{
		...
		this.imgToolCq2.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapA, this);			
		this.imgToolDq2.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapB, this);			
		this.tabControllerCq2.on(TSelectEvent.WOZTABSELECT,  this.doTabMapA, this);
		this.tabControllerDq2.on(TSelectEvent.WOZTABSELECT,  this.doTabMapB, this);
							
		// Any Changes will cause the panel to complete
		//
		this.tabControllerCq2.on("Done",  this.questionFinished);			
		this.tabControllerDq2.on("Done",  this.questionFinished);			
	}
