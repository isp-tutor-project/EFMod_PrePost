...
export class TQ3APart1 extends TExpSceneTyp1
{
	...
	constructor()
	{
		...
		this.imgToolAq3.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapA, this);			
		this.imgToolBq3.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapB, this);			
		this.tabControllerAq3.on(TSelectEvent.WOZTABSELECT,  this.doTabMapA, this);
		this.tabControllerBq3.on(TSelectEvent.WOZTABSELECT,  this.doTabMapB, this);				  						
	}
	...
	public onGotoDesign(evt:TMouseEvent)
	{
		...
		this.q3DesignButton.removeEventListener(CONST.BUTTON_CLICK, this.onGotoDesign);				
...
//****** Overridden Behaviors
	...
	public preEnterScene(Tutor:any, sceneLabel:string, sceneTitle:string, scenePage:string, Direction:string ) :string
	{
		...
		//## Mod 10 10 2012 - inhibit double click on design button - was causing skip directly to partB
		this.q3DesignButton.on(CONST.BUTTON_CLICK, this.onGotoDesign, this);				
