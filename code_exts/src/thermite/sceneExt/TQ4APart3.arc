...
import { TRocketImgTool } 		from "../../thermite/TRocketImgTool";
import { TRocketController } 	from "../../thermite/TRocketController";
import { TImgCircleControl } 		from "../TImgCircleControl";
import { TLabelControl } 		from "../TLabelControl";
...
export class TQ4APart3 extends TExpSceneTyp1
{
	...
	public q4TextControl1:THtmlText;
	
	public q4Check1:TImgCircleControl;
	public q4Check2:TImgCircleControl;
	...
	constructor()
	{
		...
		this.imgToolCq4.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapA, this);			
		this.imgToolDq4.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapB, this);			
		this.tabControllerCq4.on(TSelectEvent.WOZTABSELECT,  this.doTabMapA, this);
		this.tabControllerDq4.on(TSelectEvent.WOZTABSELECT,  this.doTabMapB, this);			
													
		// Any Changes will cause the panel to complete
		//
		this.tabControllerCq4.on("Done",  this.questionFinished);			
		this.tabControllerDq4.on("Done",  this.questionFinished);						
	}
