...
export class TQ5BPart1 extends TExpSceneTyp1
{
	...
	constructor()
	{
		...
		this.imgToolAq5.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapA, this);			
		this.imgToolBq5.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapB, this);			
		this.tabControllerAq5.on(TSelectEvent.WOZTABSELECT,  this.doTabMapA, this);
		this.tabControllerBq5.on(TSelectEvent.WOZTABSELECT,  this.doTabMapB, this);				  
	}
	...
	public onGotoDesign(evt:TMouseEvent)
	{
		...
		this.q5DesignButton.removeEventListener(CONST.BUTTON_CLICK, this.onGotoDesign);				
...
*/
		...
		//## Mod 10 10 2012 - inhibit double click on design button - was causing skip directly to partB
		this.q5DesignButton.on(CONST.BUTTON_CLICK, this.onGotoDesign, this);				
