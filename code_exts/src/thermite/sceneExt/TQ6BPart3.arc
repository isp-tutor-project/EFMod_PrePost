...
import { TMemoryImgTool } 		from "../../thermite/TMemoryImgTool";
import { TMemoryController } 	from "../../thermite/TMemoryController";
...
export class TQ6BPart3 extends TExpSceneTyp1
{
	...
	public q6TextControl1:THtmlText;
	
	public q6Check1:TImgCircleControl;
	public q6Check2:TImgCircleControl;
	...
	constructor()
	{
		...
		this.imgToolCq6.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapA, this);			
		this.imgToolDq6.on(TSelectEvent.WOZIMGSELECT,  this.doImageMapB, this);			
		this.tabControllerCq6.on(TSelectEvent.WOZTABSELECT,  this.doTabMapA, this);
		this.tabControllerDq6.on(TSelectEvent.WOZTABSELECT,  this.doTabMapB, this);
		
		// Any Changes will cause the panel to complete
		//
		this.tabControllerCq6.on("Done",  this.questionFinished);			
		this.tabControllerDq6.on("Done",  this.questionFinished);						
	}
